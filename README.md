...
If you have been following tutorials like Kaupenjoe's about ore generations but have found that in 1.20.2+ DataPackEntriesProvider class is missing, it is because someone decided to delete as "it was of no use in their opinion"
